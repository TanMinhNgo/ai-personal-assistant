...
export default function Home() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#030303] text-zinc-100 font-sans selection:bg-purple-500/30 selection:text-purple-200 flex flex-col justify-between">
      ...
      <div className="absolute top-[-10%] left-[-10%] h-150 w-150 rounded-full bg-purple-900/10 blur-[120px] pointer-events-none" />
      <div className="absolute top-[40%] right-[-10%] h-125 w-125 rounded-full bg-cyan-900/10 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[20%] h-150 w-150 rounded-full bg-emerald-950/10 blur-[150px] pointer-events-none" />
      ...
      <div className="flex flex-col flex-1">
        ...
        <main className="flex-1">
          ...
          <section className="relative mx-auto max-w-7xl px-6 pb-24 sm:px-8">
            <div className="relative rounded-3xl overflow-hidden border border-purple-500/20 bg-linear-to-br from-purple-950/20 via-zinc-950 to-black p-8 md:p-12 flex flex-col items-center text-center shadow-[0_0_50px_rgba(139,92,246,0.1)]">
