...
export type PlatformMeta = { id: string; name: string; logo: string; tileClass?: string };

export const PLATFORMS: PlatformMeta[] = [
  { id: 'gmail', name: 'Gmail', logo: '/gmail.png' },
  { id: 'whatsapp', name: 'WhatsApp', logo: '/whatsapp.png', tileClass: 'bg-[#25D366]' },
...
export const platformLogo = (id: string) => platformById[id]?.logo ?? '/globe.svg';
